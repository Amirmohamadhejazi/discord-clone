...
const CardNitro: FC<ICardNitroProps> = ({ itemsCard }) => {
    return (
        <div className='col-span-1 group'>
            <div className='flex flex-col justify-center group-hover:-translate-y-3 duration-100 ease-in-out rounded-xl bg-general-gray-300 overflow-hidden'>
                <div className='flex flex-col  pt-5 px-5 truncate'>
                ...
                <div className='p-5 group-hover:px-0 group-hover:pb-0 duration-300 w-full  relative'>
