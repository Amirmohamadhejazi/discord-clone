...
const UserProfile_icon: FC<IIconProps> = ({ size = '24', className }) => {
    return (
        <svg
            x='0'
            y='0'
        ...
        >
            <path
                ...
                className=''
            ></path>
            <path fill='currentColor' d='M24 19a5 5 0 1 1-10 0 5 5 0 0 1 10 0Z' className=''></path>
        </svg>
    )
}

export default UserProfile_icon
