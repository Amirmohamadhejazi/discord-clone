        ...
        <div className='flex w-full h-full bg-general-gray-100'>
            <div className='w-full flex relative'>
                ...
                <div className='flex container h-full absolute top-0 left-1/2 -translate-x-1/2'>
                    <div className='w-[200px] h-full overflow-auto flex flex-col gap-2  ml-36 pr-3  py-14 bg-general-gray-50 shrink-0'>
                    ...
                    <div className='grow h-full bg-general-gray-100 text-white pl-14 pr-36 py-14 overflow-y-auto'>
                        <div className='  bg-general-gray-100  grow relative  '>
                            <div
