        ...
        <div className='flex w-full h-full bg-general-gray-100   relative'>
            <div className='w-full h-full flex '>
                <div className='bg-general-gray-50 w-[600px]   pl-72'>
                    <div className='h-full overflow-auto flex flex-col gap-2 p-2 py-12 '>
                ...
                <div className='  bg-general-gray-100  pr-72 text-white px-8 overflow-y-auto'>
                    <div className='flex flex-col py-12 bg-general-gray-100 gap-y-4 grow relative  '>
                        <div
