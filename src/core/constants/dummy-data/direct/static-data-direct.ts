...
export const static_data_direct = [
    // example group
    {
        ...
        users: [
            {
                ...
                social: [
                    ...
                    },
                    {
                        name: 'Amirmohamad',
                        type: 'steam',
                        link: 'https://steamcommunity.com/profiles/76561198073694544'
                    },
                    { name: 'amirmohamad_hr', type: 'twitch', link: 'https://www.twitch.tv/amirmohamad_hr' },
                    { name: 'amirmohamad_hr', type: 'instagram', link: 'https://www.instagram.com/amirmohamad_hr' },
                    { name: 'amirmohamadhr', type: 'twitter', link: 'https://twitter.com/amirmohamadhr' }
        ...
        messages: [
            ...
            { sender: '991284573726060615', message: `hi doesn't feel like having fun`, messageId: '3', date: '' },
            {
                sender: '214280633692717056',
            ...
            },
            {
                ...
                message: `wtf?? my r6 game folder deleted!!!!! `,
                messageId: '3',
                date: ''
            },
            { sender: '991284573726060615', message: `:Pes_melt:`, messageId: '3', date: '' },
            {
                sender: '214280633692717056',
                message: `Sis`,
                messageId: '4',
